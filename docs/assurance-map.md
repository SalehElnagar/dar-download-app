...
| Unproven requests never touch storage | Denial matrix asserts zero storage calls for invalid generic or Azure identity, disallowed subject, and invalid/unknown release |
