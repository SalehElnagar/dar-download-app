...
const (
	WorkerIdentityClientIDEnv    = "HARMONY_DAR_WORKER_IDENTITY_CLIENT_ID"
	WorkerStorageAccountEnv      = "HARMONY_DAR_STORAGE_ACCOUNT_NAME"
	WorkerServiceBusNamespaceEnv = "HARMONY_DAR_SERVICEBUS_NAMESPACE"
	WorkerServiceBusQueueEnv     = "HARMONY_DAR_SERVICEBUS_QUEUE"
	WorkerManifestsContainerEnv  = "HARMONY_DAR_MANIFESTS_CONTAINER"
	WorkerBatchesContainerEnv    = "HARMONY_DAR_BATCHES_CONTAINER"
	WorkerReceiptsContainerEnv   = "HARMONY_DAR_RECEIPTS_CONTAINER"
	WorkerHMACKeyEnv             = "HARMONY_DAR_RECEIPT_HMAC_KEY_B64"
	WorkerHMACKeyVersionEnv      = "HARMONY_DAR_RECEIPT_HMAC_KEY_VERSION"
	WorkerMailModeEnv            = "HARMONY_DAR_MAIL_MODE"
	WorkerMailFromEmailEnv       = "HARMONY_DAR_MAIL_FROM_EMAIL"
	WorkerMailFromNameEnv        = "HARMONY_DAR_MAIL_FROM_NAME"
	WorkerAllowedRecipientsEnv   = "HARMONY_DAR_MAIL_ALLOWED_RECIPIENTS_JSON"
	WorkerMailAPIKeyEnv          = "HARMONY_DAR_MAIL_API_KEY"
	WorkerStubEndpointEnv        = "HARMONY_DAR_STUB_ENDPOINT"
	WorkerMaxAttemptsEnv         = "HARMONY_DAR_MAX_ATTEMPTS"
	WorkerClaimTimeoutSecondsEnv = "HARMONY_DAR_CLAIM_TIMEOUT_SECONDS"
	WorkerMailTimeoutSecondsEnv  = "HARMONY_DAR_MAIL_TIMEOUT_SECONDS"
	WorkerHealthPortEnv          = "HARMONY_DAR_HEALTH_PORT"
)
