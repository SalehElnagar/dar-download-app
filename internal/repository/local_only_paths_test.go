...
func TestProviderSpecificAdapterTermsStayInTheirOwnedBoundary(t *testing.T) {
	...
	allowed := map[string]bool{
		...
		"internal/auth/azure_container_apps_oidc.go":               true,
		"internal/auth/azure_container_apps_contract_test.go":      true,
		"internal/auth/azure_container_apps_oidc_contract_test.go": true,
		"internal/auth/azure_container_apps_oidc_fuzz_test.go":     true,
		"internal/auth/oidc_fuzz_test.go":                          true,
		"internal/config/config.go":                                true,
		"internal/config/config_test.go":                           true,
		"internal/config/custom_aca_oidc_contract_test.go":         true,
		"internal/httpapi/custom_aca_oidc_boundary_test.go":        true,
		"internal/httpapi/oidc_boundary_test.go":                   true,
		"internal/repository/custom_aca_oidc_contract_test.go":     true,
